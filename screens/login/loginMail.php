                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            <div mc:edit="body"
                                                                                ...
                                                                                You Have logged in from {{ipaddress}}
                                                                                on <?php echo date('d-m-Y : h:i:sa') ?>
                                                                                with your Username and Password If this
                                                                                is not You Please change your Password
                                                                                Immediately
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            ...
                                                                            <div mc:edit="body"
                                                                                 style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">
                                                                                This is System generated Mail ,Please
                                                                                dont reply this mail for any Queries
                                                                                contact Global Archive Developer Team,We
                                                                                are Happy to Help.
                                                                            </div>
                                                                        </td>
                                                                    </tr>
