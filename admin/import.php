...
foreach ($data as $section) {
    $sectionName = "bbox" . "_" . $section->name;
    ...
    foreach ($section->items as $item) {
        ...
        if (is_array($pick)) {
            ...
            $listcode = "bbox" . $section->name . "_" . rand(10000, 99999);
        ...
        $clist = "INSERT INTO checklist
                            VALUES (NULL, 'BBox', $j, '$d1' , NULL, '$type', '$pick1', '$listcode', 3, CURRENT_TIMESTAMP, 3, CURRENT_TIMESTAMP);";
        fwrite($fh, $clist . "\n");
        $db->setQuery($clist);
        $last = $conn->insert_id;
        ...
        $cSection = "INSERT INTO cr_section
              VALUES (NULL, '$sectionName', '$dd', 'BBox','$last', CURRENT_TIMESTAMP);";
